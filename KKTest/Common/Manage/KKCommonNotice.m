...
#import "KKCommonNotice.h"


NSTimeInterval const kDefaultMinimumDismissTimeInterval = 1.0;
static void (^_dismissSuccess)(void); ///< 目前用于 SVProgressHUD 关闭提示时回调
...
+ (void)initSVProgressHUD {
    [SVProgressHUD setMinimumDismissTimeInterval:kDefaultMinimumDismissTimeInterval]; // 用于 Info、Success、Error 提示
    [SVProgressHUD setDefaultStyle:SVProgressHUDStyleCustom];
    [SVProgressHUD setBackgroundColor:[UIColor colorWithWhite:0.100 alpha:0.850]];
    [SVProgressHUD setForegroundColor:kColorOfWhite];
